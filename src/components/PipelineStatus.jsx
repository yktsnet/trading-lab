          ...
          return (
            ...
            >
              ...
              <div className="col-time" style={{
                ...
                justifyContent: 'flex-end', gap: 4, fontSize: 12, whiteSpace: 'nowrap',
                ...
                {isRecent(s.last_run) && (
                  <span style={{
                    fontSize: 9, letterSpacing: '0.08em', color: 'var(--accent)',
                    marginLeft: 4, padding: '1px 4px',
                    border: '1px solid var(--accent)44', borderRadius: 2,
                  }}>NEW</span>
                )}
              </div>
